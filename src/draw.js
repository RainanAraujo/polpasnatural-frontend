...
export default function MenuButton(props) {
  ...
  return (
    <div>
      ...
      >
        <Button style={{ margin: 10 }} onClick={scrollInicio}>
          <text style={{ color: "#fff", fontSize: "1.6rem" }}>INÍCIO</text>
        </Button>
        <Button style={{ margin: 10 }}>
          <text style={{ color: "#fff", fontSize: "1.6rem" }}>CONHEÇA-NOS</text>
        </Button>
        <Button style={{ margin: 10 }} onClick={scrollContato}>
          <text style={{ color: "#fff", fontSize: "1.6rem" }}>CONTATO</text>
        </Button>
        <Grid
          style={{
            display: "flex",
        ...
        >
          ...
          <IconButton
            href=""
            style={{ backgroundColor: "#F2B705", marginRight: 20 }}
          >
